...
[nerex](https://github.com/hec-ovi/nerex) reaches further back: it comes from the early AI implementations I did at ADGS (Doha, 2018-2024), NLP before GPT was a product. Financial entity and number extraction compared across four engines (regex, spaCy, word2number, BERT), Flask API, Docker. ADGS is also where I built a cybersecurity telemetry layer at the application frontend: vanilla JS that captured per-key timing, pressure, gyroscope, and location, and streamed it to a biometric-verification backend that decided whether you were really you.

<h2 align="center">Experience</h2>

More than 3 years shipping agentic AI, on an AI track that started with pre-GPT NLP at ADGS, on top of 23+ years of production software: games, real-time apps, and frontend platforms. Open to remote senior Applied AI roles and specialist contracts: agent systems, MCP integrations, RAG, generative AI, local inference. Reach me through [hec-ovi.dev](https://hec-ovi.dev) or [LinkedIn](https://linkedin.com/in/hec-ovi).
